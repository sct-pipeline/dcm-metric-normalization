...
# Note: -anat is used for HOG and symmetry morphometrics.
...
sct_process_segmentation -anat ${file_t2w}.nii.gz -i ${file_t2w_seg}.nii.gz -discfile ${file_t2w_labels}.nii.gz -perslice 1 -normalize-PAM50 1 -v 2 -o ${PATH_RESULTS}/PAM50/${file_t2w}_PAM50.csv
